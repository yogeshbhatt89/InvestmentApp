...
import { profileIcons } from '@/modules/Icon/icons'
const RegisterComponent = () => {
  ...
  const { closeDialog } = useDialog('register-dialog')
        ...
        <BoxComponent component="form" onSubmit={handleRegisterSubmit} noValidate>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-4">
            ...
            <ButtonComponent
              ...
              label="Go to Login"
              type="button"
              onClick={() => { closeDialog(); openDialog(); }}
              variant="outlined"
            />
          </div>
        </BoxComponent>
