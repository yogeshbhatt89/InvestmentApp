...
const ListItemTextComponent: React.FC<ListItemTextComponentProps> = ({ primary, secondary, className }) => {
  return (
    <ListItemText primary={primary} secondary={secondary} className={className} />
  );
};
